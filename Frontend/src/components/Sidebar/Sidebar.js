...
import { Info, BookOpen, LogIn, LogOut, UserCheck, CompassIcon, DraftingCompassIcon, LucideCompass, AtomIcon, NewspaperIcon } from "lucide-react";
import "./Sidebar.css";
  ...
  return (
    <div className="sidebar">
      ...
      <div className="sidebar-middle">
        <div className="add-section"><button className="add-button" onClick={handleAddClick}>+</button></div>
