...
const leadSlogans = [
  { heading: "Good afternoon!", subheading: "Ready to discover your next great lead?" },
  { heading: "Welcome!", subheading: "Let's find the perfect prospects for your business." },
  { heading: "Hello!", subheading: "Time to turn conversations into conversions." },
  { heading: "Good day!", subheading: "Ready to generate some quality leads?" },
  { heading: "Hi there!", subheading: "Let's explore opportunities together." }
];
      ...
      {messages.length === 0 ? (
        <div className="perplexity-layout">
          <div className="page-title">
            <h1 className="slogan-heading">{currentSlogan.heading}</h1>
            <p className="slogan-subheading">{currentSlogan.subheading}</p>
          </div>
