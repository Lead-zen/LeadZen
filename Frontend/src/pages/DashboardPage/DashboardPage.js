...
const DashboardPage = () => {
  ...
  return (
    <div className="dashboard-page min-h-screen bg-white flex w-full">
      <DashboardSidebar 
        isOpen={sidebarOpen}
      ...
      <div className="flex-1 flex flex-col w-full min-w-0">
        ...
        <main className="flex-1 overflow-hidden dashboard-main w-full bg-white">
          ...
          {currentView === 'leads' && (
            <LeadDashboard 
              ...
              onNavigateToAIGeneration={() => setCurrentView('generate')}
            />
          )}
